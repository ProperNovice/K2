...
public enum Dimensions {
	...
	RISK_TOKEN_GAME(RISK_TOKEN_ORIGINAL.x() * (Dimensions.FRAME.x() - Dimensions.GAP_BETWEEN_BORDERS.x() - Coordinates.DECK.x() - 9 * Dimensions.GAP_BETWEEN_COMPONENTS.x()) / (10 * Dimensions.RISK_TOKEN_ORIGINAL.x()), RISK_TOKEN_ORIGINAL.y() * (Dimensions.FRAME.x() - Dimensions.GAP_BETWEEN_BORDERS.x() - Coordinates.DECK.x() - 9 * Dimensions.GAP_BETWEEN_COMPONENTS.x()) / (10 * Dimensions.RISK_TOKEN_ORIGINAL.y())),
