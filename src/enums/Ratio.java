...
public enum Ratio {
	...
	WEATHER_TILE((Dimensions.FRAME.x() - 2 * Dimensions.GAP_BETWEEN_BORDERS.x() - Dimensions.MAP_ORIGINAL.x() * MAP.ratio() - Dimensions.GAP_BETWEEN_COMPONENTS.x()) / (2 * Dimensions.WEATHER_TILE_ORIGINAL.x())),
