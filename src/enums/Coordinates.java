...
public enum Coordinates {
	...
	SCORE_TRACK_EASY_MAP_TOP_LEFT(MAP.x() + 996 * Ratio.MAP.ratio() + ((1143 - 996) * Ratio.MAP.ratio() - 2 * Dimensions.MOUNTAINEER_GAME.x() - Dimensions.GAP_BETWEEN_COMPONENTS.x()) / 2, -1),
	RESTART_BUTTON(ACCLIMATIZATION_INDICATOR.x() + Dimensions.GAP_BETWEEN_COMPONENTS.x(), ACCLIMATIZATION_INDICATOR.y() + Dimensions.ACCLIMATIZATION_INDICATOR_GAME.y() - Dimensions.RESTART_BUTTON.y() - Dimensions.GAP_BETWEEN_COMPONENTS.y()),
