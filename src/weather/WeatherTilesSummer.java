...
public class WeatherTilesSummer {
	...
	public static ArrayList<WeatherTile> getTiles() {
		...
		weatherTiles.add(new WeatherTile("summer/1", first, second, third));
		...
		weatherTiles.add(new WeatherTile("summer/2", first, second, third));
		...
		weatherTiles.add(new WeatherTile("summer/3", first, second, third));
		...
		weatherTiles.add(new WeatherTile("summer/4", first, second, third));
		...
		weatherTiles.add(new WeatherTile("summer/5", first, second, third));
		...
		weatherTiles.add(new WeatherTile("summer/6", first, second, third));
